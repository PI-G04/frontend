...
function Navbar() {
  ...
  if (usuario.token !== "") {
    ...
    navbarComponent = (
      ...
      // <div className='w-full bg-purple-400 text-white flex justify-center py-4 font-title '>
      //   <div className="container flex justify-between text-lg">
      //     <Link to='/home' className='text-3xl '>Minas na Área</Link>

      //     <div className='flex gap-8 text-xl'>
      //        <button className='rounded-nav w-20 transition ease-in-out bg-purple-400 hover:-translate-y-1 hover:scale-110 hover:bg-green-100  duration-300 '><Link to='/home'>Home</Link> </button> 
      //        <button className='rounded-nav w-20 transition ease-in-out bg-purple-400 hover:-translate-y-1 hover:scale-110 hover:bg-green-100  duration-300 '><Link to='/sobre' className='hover:underline'>Sobre</Link> </button>
      //        <button className='rounded-nav w-28 transition ease-in-out bg-purple-400 hover:-translate-y-1 hover:scale-110 hover:bg-green-100  duration-300 '><Link to='/postagens'>Postagens</Link> </button>
      //        <button className='rounded-nav w-20 transition ease-in-out bg-purple-400 hover:-translate-y-1 hover:scale-110 hover:bg-green-100  duration-300 '><Link to='/login' className='hover:underline'>Login</Link></button>
      //     </div>
      //   </div>
      // </div>
    )
